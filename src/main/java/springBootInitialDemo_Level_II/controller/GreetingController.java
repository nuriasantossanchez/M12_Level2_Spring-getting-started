package springBootInitialDemo_Level_II.controller;
...
import springBootInitialDemo_Level_II.service.IGreetingService;
 ...
 * http://localhost:8081, en este caso
...
public class GreetingController{
    ...
    /**
     * Representa el mapeo de una peticion HTTP GET, a la URL http://localhost:8081
     *
